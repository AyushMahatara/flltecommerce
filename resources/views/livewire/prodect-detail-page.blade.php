        ...
        <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
            <div class="flex flex-wrap -mx-4">
                <div class="w-full mb-8 md:w-1/2 md:mb-0"
                    x-data="{ mainImage: '{{ asset($product->getFirstMediaUrl('products.thumbnails')) }}' }">
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        ...
                        <div class="flex-wrap hidden md:flex ">
                            @foreach ($product->getMedia('products.thumbnails') as $media)
                            <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{ $media->getUrl() }}'">
                ...
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="lg:pl-20">
                        <div class="mb-8 [&>ul]:list-disc [&>ul]:list-inside [&>ul]:ml-4">
                            <h2 class="max-w-xl mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl">
                                {{ $product->name }}</h2>
                            <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                <span>{{ Number::currency($product->price, 'NRP') }}</span>
                                {{-- <span
                        ...
                        <div class="w-32 mb-8 ">
                            ...
                            <div class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg">
                                <button wire:click='descreaseQuantity'
