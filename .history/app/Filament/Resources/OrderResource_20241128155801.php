                ...
                Group::make()->schema([
                    ...
                    Section::make('Order Items')->schema([
                        Repeater::make('items')->relationship()->schema([
                            Select::make('product_id')->label('Product')->searchable()->preload()->required()->distinct()->relationship('product', 'name')->disableOptionsWhenSelectedInSiblingRepeaterItems()->columnSpan(4),
                            TextInput::make('quantity')->required()->numeric()->default(1)->minValue(1)->columnSpan(2),
                            TextInput::make('unit_amount')->required()->numeric()->disabled()->default(0)->columnSpan(2),
                            TextInput::make('total_amount')->required()->numeric()->default(0)->columnSpan(2),
                        ])->columns(12),
                    ])
                ])->columnSpanFull(),
            ]);
