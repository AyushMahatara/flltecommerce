    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                IconColumn::make('in_stock')->searchable()->sortable(),
                IconColumn::make('is_active')->searchable()->sortable(),
                IconColumn::make('is_featured')->searchable()->sortable(),
                IconColumn::make('on_sale')->searchable()->sortable(),
