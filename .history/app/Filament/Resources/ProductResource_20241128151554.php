    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('in_stock')->searchable()->sortable(),
                TextColumn::make('is_active')->searchable()->sortable(),
                TextColumn::make('is_featured')->searchable()->sortable(),
                TextColumn::make('on_sale')->searchable()->sortable(),
